...
const TOPIC_RULES = [
  [/\bsam\b|serverless application model/i, "CloudFormation"],
  [/codepipeline|code pipeline/i, "CodePipeline"],
  [/codedeploy|code deploy/i, "CodeDeploy"],
  [/codecommit|code commit/i, "CodeCommit"],
  [/codebuild|code build/i, "CodeBuild"],
  [/cloudformation/i, "CloudFormation"],
  [/cloudfront/i, "CloudFront"],
  [/cloudwatch/i, "CloudWatch"],
  [/elastic beanstalk|\bbeanstalk\b/i, "Elastic Beanstalk"],
  [/step functions/i, "Step Functions"],
  [/eventbridge|event bridge/i, "EventBridge"],
  [/secrets manager/i, "Secrets Manager"],
  [/elasticache|\bredis\b|\bmemcached\b/i, "ElastiCache"],
  [/api.?gateway/i, "API Gateway"],
  [/dynamodb/i, "DynamoDB"],
  [/kinesis/i, "Kinesis"],
  [/cognito/i, "Cognito"],
  [/x-ray|\bxray\b/i, "X-Ray"],
  [/\becs\b|\bfargate\b/i, "ECS"],
  [/\brds\b|\baurora\b/i, "RDS"],
  [/\bkms\b|customer master key|\bcmk\b/i, "KMS"],
  [/\bsns\b|simple notification service/i, "SNS"],
  [/\bsqs\b|simple queue service/i, "SQS"],
  [/\blambda\b/i, "Lambda"],
  [/\bs3\b|amazon s3/i, "S3"],
  [/\biam\b/i, "IAM"],
];

const QUESTIONS = [
  {
    "q": "Which of the following are good use cases for how Amazon ElastiCache can help an application? (Select TWO)",
    "options": [
  ...
  {
    "q": "Which of the following services are key/value stores? (Choose 3 answers)",
    "options": [
      "Amazon ElastiCache.",
  ...
  {
    "q": "A developer wants to send multi-value headers to an AWS Lambda function that is registered as a target with an Application Load Balancer (ALB). What should the developer do to achieve this?",
    "options": [
  ...
  {
    "q": "A Developer wants to upload data to Amazon S3 and must encrypt the data in transit. Which of the following solutions will accomplish this task? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A Developer wants to encrypt new objects that are being uploaded to an Amazon S3 bucket by an application. There must be an audit trail of who has used the key during this process. There should be no change to the performance of the application. Which type of encryption meets these requirements?",
    "options": [
  ...
  {
    "q": "An application is being developed to audit several AWS accounts. The application will run in Account A and must access AWS services in Accounts B and C. What is the MOST secure way to allow the application to call AWS services in each audited account?",
    "options": [
  ...
  {
    "q": "A company uses a third-party tool to build, bundle, and package its applications on-premises and store them locally. The company uses Amazon EC2 instances to run its front-end applications. How can an application be deployed from the source control system onto the EC2 instances?",
    "options": [
  ...
  {
    "q": "A global company has an application running on Amazon EC2 instances that serves image files from Amazon S3. User requests from the browser are causing high traffic, which results in degraded performance. Which optimization solution should a Developer implement to increase application performance?",
    "options": [
  ...
  {
    "q": "An application deployed on AWS Elastic Beanstalk experiences increased error rates during deployments of new application versions, resulting in service degradation for users. The Development team believes that this is because of the reduction in capacity during the deployment steps. The team would like to change the deployment policy configuration of the environment to an option that maintains full capacity during deployment while using the existing instances. Which deployment policy will meet these requirements while using the existing instances?",
    "options": [
      "All at once.",
      "Rolling.",
  ...
  {
    "q": "A Developer is creating an application that needs to locate the public IPv4 address of the Amazon EC2 instance on which it runs. How can the application locate this information?",
    "options": [
  ...
  {
    "q": "The development team is working on an API that will be served from Amazon API gateway. The API will be served from three environments: development, test, and production. The API Gateway is configured to use 237 GB of cache in all three stages. Which is the MOST cost-efficient deployment strategy?",
    "options": [
  ...
  {
    "q": "A company is migrating its on-premises database to Amazon RDS for MySQL. The company has read-heavy workloads, and wants to make sure it re-factors its code to achieve optimum read performance for its queries. How can this objective be met?",
    "options": [
  ...
  {
    "q": "A Developer is making changes to a custom application that is currently using AWS Elastic Beanstalk. After the Developer completes the changes, what solutions will update the Elastic Beanstalk environment with the new application version? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A company is running an application built on AWS Lambda functions. One Lambda function has performance issues when it has to download a 50MB file from the Internet in every execution. This function is called multiple times a second. What solution would give the BEST performance increase?",
    "options": [
  ...
  {
    "q": "Queries to an Amazon DynamoDB table are consuming a large amount of read capacity. The table has a significant number of large attributes. The application does not need all of the attribute data. How can DynamoDB costs be minimized while maximizing application performance?",
    "options": [
  ...
  {
    "q": "A development team is creating a new application designed to run on AWS. While the test and production environments will run on Amazon EC2 instances, developers will each run their own environment on their laptops. Which of the following is the simplest and MOST secure way to access AWS services from the local development machines?",
    "options": [
  ...
  {
    "q": "How is provisioned throughput affected by the chosen consistency model when reading data from a DynamoDB table?",
    "options": [
  ...
  {
    "q": "A developer needs to deploy a new version to an AWS Elastic Beanstalk application. How can the developer accomplish this task?",
    "options": [
  ...
  {
    "q": "A developer wants the ability to roll back to a previous version of an AWS Lambda function in the event of errors caused by a new deployment. How can the developer achieve this with MINIMAL impact on users?",
    "options": [
  ...
  {
    "q": "An application contains two components: one component to handle HTTP requests, and another component to handle background processing tasks. Each component must scale independently. The developer wants to deploy this application using AWS Elastic Beanstalk. How should this application be deployed, based on these requirements?",
    "options": [
  ...
  {
    "q": "A company is using AWS CloudFormation templates to deploy AWS resources. The company needs to update one of its AWS CloudFormation stacks. What can the company do to find out how the changes will impact the resources that are running?",
    "options": [
  ...
  {
    "q": "An application running on EC2 instances is storing data in an S3 bucket. Security policy mandates that all data must be encrypted in transit. How can the Developer ensure that all traffic to the S3 bucket is encrypted?",
    "options": [
  ...
  {
    "q": "A supplier is writing a new RESTful API for customers to query the status of orders. The customers requested the following API endpoint `http://www.supplierdomain.com/status/customerID`. Which of the following application designs meet the requirements? (Select TWO)",
    "options": [
  ...
  {
    "q": "A developer Is designing an AWS Lambda function that create temporary files that are less than 10 MB during execution. The temporary files will be accessed and modified multiple times during execution. The developer has no need to save or retrieve these files in the future. Where should the temporary file be stored?",
    "options": [
      "the `/tmp` directory.",
      "Amazon EFS.",
      "Amazon EBS.",
  ...
  {
    "q": "An advertising company has a dynamic website with heavy traffic. The company wants to migrate the website infrastructure to AWS to handle everything except website development. Which solution BEST meets these requirements?",
    "options": [
  ...
  {
    "q": "A developer is writing an AWS Lambda function. The developer wants to log key events that occur during the Lambda function and include a unique identifier to associate the events with a specific function invocation. Which of the following will help the developer accomplish this objective?",
    "options": [
  ...
  {
    "q": "A company stores all personally identifiable information (PII) in an Amazon DynamoDB table named PII in Account A. An application running on Amazon EC2 instances in Account B requires access to the PII table. An administrators in Account A created an IAM role named AccessPII with privileges to access the PII table, and made account B a trusted entity. Which combination of actional steps should Developers take to access the table? (Select TWO)",
    "options": [
  ...
  {
    "q": "An AWS Lambda function accesses two Amazon DynamoDB tables. A developer wants to improve the performance of the Lambda function by identifying bottlenecks in the function. How can the developer inspect the timing of the DynamoDB API calls?",
    "options": [
  ...
  {
    "q": "A company is developing a serverless ecommerce web application. The application needs to make coordinated, all-or-nothing changes to multiple items in the company's inventory table in Amazon DynamoDB. Which solution will meet these requirements?",
    "options": [
  ...
  {
    "q": "An application is running on an EC2 instance. The Developer wants to store an application metric in Amazon CloudWatch. What is the best practice for implementing this requirement?",
    "options": [
  ...
  {
    "q": "A Developer needs to design an application running on AWS that will be used to consume Amazon SQS messages that range from 1 KB up to 1GB in size. How should the Amazon SQS messages be managed?",
    "options": [
  ...
  {
    "q": "A developer has written a multi-threaded application that is running on a fleet of Amazon EC2 instances. The operations team has requested a graphical method to monitor the number of running threads over time. What is the MOST efficient way to fulfill this request?",
    "options": [
  ...
  {
    "q": "An application on AWS is using third-party APIs. The Developer needs to monitor API errors in the code, and wants to receive notifications if failures go above a set threshold value. How can the Developer achieve these requirements?",
    "options": [
  ...
  {
    "q": "The release process workflow of an application requires a manual approval before the code is deployed into the production environment. What is the BEST way to achieve this using AWS CodePipeline?",
    "options": [
  ...
  {
    "q": "A Developer is asked to implement a caching layer in front of Amazon RDS. Cached content is expensive to regenerate in case of service failure. Which implementation below would work while maintaining maximum uptime?",
    "options": [
  ...
  {
    "q": "A company has written a Java AWS Lambda function to be triggered whenever a user uploads an image to an Amazon S3 bucket. The function converts the original image to several different formats and then copies the resulting images to another Amazon S3 bucket. The Developers find that no images are being copied to the second Amazon S3 bucket. They have tested the code on an Amazon EC2 instance with 1GB of RAM, and it takes an average of 500 seconds to complete. What is the MOST likely cause of the problem?",
    "options": [
  ...
  {
    "q": "A web application is using Amazon Kinesis Streams for clickstream data that may not be consumed for up to 12 hours. How can the Developer implement encryption at rest for data within the Kinesis Streams?",
    "options": [
  ...
  {
    "q": "A company wants to migrate its web application to AWS and leverage Auto Scaling to handle peak workloads. The Solutions Architect determined that the best metric for an Auto Scaling event is the number of concurrent users. Based on this information, what should the Developer use to autoscale based on concurrent users?",
    "options": [
  ...
  {
    "q": "A Developer has written a serverless application using multiple AWS services. The business logic is written as a Lambda function which has dependencies on third-party libraries. The Lambda function endpoints will be exposed using Amazon API Gateway. The Lambda function will write the information to Amazon DynamoDB. The Developer is ready to deploy the application but must have the ability to rollback. How can this deployment be automated, based on these requirements?",
    "options": [
  ...
  {
    "q": "A game stores user game data in an Amazon DynamoDB table. Individual users should not have access to other users' game data. How can this be accomplished?",
    "options": [
  ...
  {
    "q": "A Developer is creating a web application that requires authentication, but also needs to support guest access to provide users limited access without having to authenticate. What service can provide support for the application to allow guest access?",
    "options": [
  ...
  {
    "q": "Given the source code for an AWS Lambda function in the local `store.py` containing a handler function called `get_store` and the following AWS CloudFormation template. What should be done to prepare the template so that it can be deployed using the AWS CLI command `aws cloudformation deploy`?",
    "options": [
  ...
  {
    "q": "A serverless application uses an API Gateway and AWS Lambda. Where should the Lambda function store its session information across function calls?",
    "options": [
  ...
  {
    "q": "An application reads data from an Amazon DynamoDB table. Several times a day, for a period of 15 seconds, the application receives multiple `ProvisionedThroughputExceeded` errors. How should this exception be handled?",
    "options": [
  ...
  {
    "q": "A Developer is writing a Linux-based application to run on AWS Elastic Beanstalk. Application requirements state that the application must maintain full capacity during updates while minimizing cost. Which type of Elastic Beanstalk deployment policy should the Developer specify for the environment?",
    "options": [
      "Immutable.",
      "Rolling.",
      "All at Once.",
  ...
  {
    "q": "When writing a Lambda function, what is the benefit of instantiating AWS clients outside the scope of the handler?",
    "options": [
  ...
  {
    "q": "A current architecture uses many Lambda functions invoking one another as large state machine. The coordination of this state machine is legacy custom code that breaks easily. Which AWS Service can help refactor and manage the state machine?",
    "options": [
      "AWS Data Pipeline.",
  ...
  {
    "q": "A mobile app stores blog posts in an Amazon DynamoDB table. Millions of posts are added every day, and each post represents a single item in the table. The mobile app requires only recent posts. Any post that is older than 48 hours can be removed. What is the MOST cost-effective way to delete posts that are older than 48 hours?",
    "options": [
  ...
  {
    "q": "A Developer is receiving HTTP `400`: `ThrottlingException` errors intermittently when calling the Amazon CloudWatch API. When a call fails, no data is retrieved. What best practice should first be applied to address this issue?",
    "options": [
  ...
  {
    "q": "An application is real-time processing millions of events that are received through an API. What service could be used to allow multiple consumers to process the data concurrently and MOST cost-effectively?",
    "options": [
  ...
  {
    "q": "Where should the `appspec.yml` file be placed in order for AWS CodeDeploy to work?",
    "options": [
  ...
  {
    "q": "An application will ingest data at a very high throughput from many sources and must store the data in an Amazon S3 bucket. Which service would BEST accomplish this task?",
    "options": [
      "Amazon Kinesis Firehose.",
  ...
  {
    "q": "A Developer is creating a Lambda function and will be using external libraries that are not included in the standard Lambda libraries. What action would minimize the Lambda compute time consumed?",
    "options": [
  ...
  {
    "q": "During non-peak hours, a Developer wants to minimize the execution time of a full Amazon DynamoDB table scan without affecting normal workloads. The workloads average half of the strongly consistent read capacity units during non-peak hours. How would the Developer optimize this scan?",
    "options": [
  ...
  {
    "q": "A large e-commerce site is being designed to deliver static objects from Amazon S3. The Amazon S3 bucket will server more than 300 GET requests per second. What should be done to optimize performance? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A legacy service has an XML-based SOAP interface. The Developer wants to expose the functionality of the service to external clients with the Amazon API Gateway. Which technique will accomplish this?",
    "options": [
  ...
  {
    "q": "A customer wants to deploy its source code on an AWS Elastic Beanstalk environment. The customer needs to perform deployment with minimal outage and should only use existing instances to retain application access log. What deployment policy would satisfy these requirements?",
    "options": [
      "Rolling.",
      "All at once.",
  ...
  {
    "q": "A Developer has setup an Amazon Kinesis Stream with 4 shards to ingest a maximum of 2500 records per second. A Lambda function has been configured to process these records. In which order will these records be processed?",
    "options": [
  ...
  {
    "q": "An organization must store thousands of sensitive audio and video files in an Amazon S3 bucket. Organizational security policies require that all data written to this bucket be encrypted. How can compliance with this policy be ensured?",
    "options": [
  ...
  {
    "q": "An application is designed to use Amazon SQS to manage messages from many independent senders. Each sender's messages must be processed in the order they are received. Which SQS feature should be implemented by the Developer?",
    "options": [
  ...
  {
    "q": "A Developer created a dashboard for an application using Amazon API Gateway, Amazon S3, AWS Lambda, and Amazon RDS. The Developer needs an authentication mechanism allowing a user to sign in and view the dashboard. It must be accessible from mobile applications, desktops, and tablets, and must remember user preferences across platforms. Which AWS service should the Developer use to support this authentication scenario?",
    "options": [
      "AWS KMS.",
      "Amazon Cognito.",
  ...
  {
    "q": "A Lambda function is packaged for deployment to multiple environments, including development, test, production, etc. Each environment has unique set of resources such as databases, etc. How can the Lambda function use the resources for the current environment?",
    "options": [
  ...
  {
    "q": "A Developer needs temporary access to resources in a second account. What is the MOST secure way to achieve this?",
    "options": [
  ...
  {
    "q": "A Developer needs to use AWS X-Ray to monitor an application that is deployed on EC2 instances. What steps have to be executed to perform the monitoring?",
    "options": [
  ...
  {
    "q": "A Developer is creating an Auto Scaling group whose instances need to publish a custom metric to Amazon CloudWatch. Which method would be the MOST secure way to authenticate a CloudWatch PUT request?",
    "options": [
  ...
  {
    "q": "A Developer is working on an application that tracks hundreds of millions of product reviews in an Amazon DynamoDB table. The records include the data elements shown in the table. Which field, when used as the partition key, would result in the MOST consistent performance using DynamoDB?",
    "options": [
      "`starRating`.",
      "`reviewID`.",
      "`comment`.",
  ...
  {
    "q": "A company needs to encrypt data at rest, but it wants to leverage an AWS managed service using its own master key. Which of the following AWS service can be used to meet these requirements?",
    "options": [
      "SSE with Amazon S3.",
      "SSE with AWS KMS.",
      "Client-side encryption.",
  ...
  {
    "q": "A Developer has created a software package to be deployed on multiple EC2 instances using IAM roles. What actions could be performed to verify IAM access to get records from Amazon Kinesis Streams? (Select TWO)",
    "options": [
  ...
  {
    "q": "A company wants to implement a continuous integration for its workloads on AWS. The company wants to trigger unit test in its pipeline for commits-on its code repository, and wants to be notified of failure events in the pipeline. How can these requirements be met?",
    "options": [
  ...
  {
    "q": "An application takes 40 seconds to process instructions received in an Amazon SQS message. Assuming the SQS queue is configured with the default `VisibilityTimeout` value, what is the BEST way, upon receiving a message, to ensure that no other instances can retrieve a message that has already been processed or is currently being processed?",
    "options": [
  ...
  {
    "q": "A Developer is developing an application that manages financial transactions. To improve security, multi-factor authentication (MFA) will be required as part of the login protocol. What services can the Developer use to meet these requirements?",
    "options": [
  ...
  {
    "q": "A Developer is writing transactions into a DynamoDB table called `SystemUpdates` that has 5 write capacity units. Which option has the highest read throughput?",
    "options": [
  ...
  {
    "q": "A company is using AWS CodeBuild to compile a website from source code stored in AWS CodeCommit. A recent change to the source code has resulted in the CodeBuild project being unable to successfully compile the website. How should the Developer identify the cause of the failures?",
    "options": [
  ...
  {
    "q": "For a deployment using AWS CodeDeploy, what is the run order of the hooks for in-place deployments?",
    "options": [
  ...
  {
    "q": "A Developer executed a AWS CLI command and received the error shown below. What action should the Developer perform to make this error human-readable?",
    "options": [
  ...
  {
    "q": "A Developer uses AWS CodeDeploy to automate application deployment that connects to an external MySQL database. The Developer wants to securely access the encrypted secrets, such as API keys and database passwords. Which of the following solutions would involve the LEAST administrative effort?",
    "options": [
  ...
  {
    "q": "An application stops working with the following error: `The specified bucket does not exist`. Where is the BEST place to start the root cause analysis?",
    "options": [
  ...
  {
    "q": "A Developer will be using the AWS CLI on a local development server to manage AWS services. What can be done to ensure that the CLI uses the Developer's IAM permissions when making commands?",
    "options": [
  ...
  {
    "q": "An application stores images in an S3 bucket. Amazon S3 event notifications are used to trigger a Lambda function that resizes the images. Processing each image takes less than a second. How will AWS Lambda handle the additional traffic?",
    "options": [
  ...
  {
    "q": "A Developer created a Lambda function for a web application backend. When testing the Lambda function from the AWS Lambda console, the Developer can see that the function is being executed, but there is no log data being generated in Amazon CloudWatch Logs, even after several minutes. What could cause this situation?",
    "options": [
  ...
  {
    "q": "A Developer wants to use AWS X-Ray to trace a user request end-to-end throughput the software stack. The Developer made the necessary changes in the application tested it, and found that the application is able to send the traces to AWS X-Ray. However, when the application is deployed to an EC2 instance, the traces are not availableWhich of the following could create this situation? (Choose TWO)",
    "options": [
  ...
  {
    "q": "An application has hundreds of users. Each user may use multiple devices to access the application. The Developer wants to assign unique identifiers to these users regardless of the device they use. Which of the following methods should be used to obtain unique identifiers?",
    "options": [
  ...
  {
    "q": "What are the steps to using the AWS CLI to launch a templatized serverless application?",
    "options": [
  ...
  {
    "q": "An application overwrites an object in Amazon S3, and then immediately reads the same object. Why would the application sometimes retrieve the old version of the object?",
    "options": [
  ...
  {
    "q": "An application under development is required to store hundreds of video files. The data must be encrypted within the application prior to storage, with a unique key for each video file. How should the Developer code the application?",
    "options": [
  ...
  {
    "q": "A developer is testing an application that invokes an AWS Lambda function asynchronously. During the testing phase, the Lambda function fails to process after two retries. How can the developer troubleshoot the failure?",
    "options": [
  ...
  {
    "q": "A developer is creating an AWS Lambda function that generates a new file each time it runs. Each new file must be checked into an AWS CodeCommit repository hosted in the same AWS account. How should the developer accomplish this?",
    "options": [
  ...
  {
    "q": "A developer must ensure that the IAM credentials used by an application in Amazon EC2 are not misused or compromised. What should the developer use to keep user credentials secure?",
    "options": [
  ...
  {
    "q": "A company has an application where reading objects from Amazon S3 is based on the type of user. The user types are registered user and guest user. The company has 25,000 users and is growing. Information is pulled from an S3 bucket depending on the user type. Which approaches are recommended to provide access to both user types? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A company has developed a new serverless application using AWS Lambda functions that will be deployed using the AWS Serverless Application Model (AWS SAM) CLI. Which step should the developer complete prior to deploying the application?",
    "options": [
  ...
  {
    "q": "An application needs to encrypt data that is written to Amazon S3 where the keys are managed in an on-premises data center, and the encryption is handled by S3. Which type of encryption should be used?",
    "options": [
  ...
  {
    "q": "A development team wants to run their container workloads on Amazon ECS. Each application container needs to share data with another container to collect logs and metrics. What should the developer team do to meet these requirements?",
    "options": [
  ...
  {
    "q": "An ecommerce startup is preparing for an annual sales event. As the traffic to the company's application increases, the development team wants to be notified when the Amazon EC2 instance's CPU utilization exceeds 80%. Which solution will meet this requirement?",
    "options": [
  ...
  {
    "q": "An application running on Amazon EC2 opens connections to an Amazon RDS SQL Server database. The developer does not want to store the user name and password for the database in the code. The developer would also like to automatically rotate the credentials. What is the MOST secure way to store and access the database credentials?",
    "options": [
  ...
  {
    "q": "A developer is updating an application deployed on AWS Elastic Beanstalk. The new version is incompatible with the old version. To successfully deploy the update, a full cutover to the new, updated version must be performed on all instances at one time, with the ability to roll back changes in case of a deployment failure in the new version. How can this be performed with the LEAST amount of downtime?",
    "options": [
  ...
  {
    "q": "A company is developing a report executed by AWS Step Functions, Amazon CloudWatch shows errors in the Step Functions task state machine. To troubleshoot each task, the state input needs to be included along with the error message in the state output. Which coding practice can preserve both the original input and the error for the state?",
    "options": [
  ...
  {
    "q": "A developer receives the following error message when trying to launch or terminate an Amazon EC2 instance using a boto3 script. What should the developer do to correct this error message?",
    "options": [
  ...
  {
    "q": "Given the following AWS CloudFormation template. What is the MOST efficient way to reference the new Amazon S3 bucket from another AWS CloudFormation template?",
    "options": [
  ...
  {
    "q": "A developer is using AWS CodeDeploy to deploy an application running on Amazon EC2. The developer wants to change the file permissions for a specific deployment file. Which lifecycle event should a developer use to meet this requirement?",
    "options": [
      "AfterInstall.",
      "DownloadBundle.",
      "BeforeInstall.",
  ...
  {
    "q": "A developer is using Amazon DynamoDB to store application data. The developer wants to further improve application performance by reducing response times for read and write operations. Which DynamoDB feature should be used to meet these requirements?",
    "options": [
  ...
  {
    "q": "A developer is creating a script to automate the deployment process for a serverless application. The developer wants to use an existing AWS Serverless Application Model (AWS SAM) template for the application. What should the developer use for the project? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A development team is designing a mobile app that requires multi-factor authentication. Which steps should be taken to achieve this? (Choose TWO)",
    "options": [
  ...
  {
    "q": "Two containerized microservices are hosted on Amazon EC2 ECS. The first microservice reads an Amazon RDS Aurora database instance, and the second microservice reads an Amazon DynamoDB table. How can each microservice be granted the minimum privileges?",
    "options": [
  ...
  {
    "q": "A developer has written an AWS Lambda function using Java as the runtime environment. The developer wants to isolate a performance bottleneck in the code. Which steps should be taken to reveal the bottleneck?",
    "options": [
  ...
  {
    "q": "A developer added a new feature to an application running on an Amazon EC2 instance that uses Amazon SQS. After deployment, the developer noticed a significant increase in Amazon SQS costs. When monitoring the Amazon SQS metrics on Amazon CloudWatch, the developer found that on average one message per minute is posted on this queue. What can be done to reduce Amazon SQS costs for this application?",
    "options": [
  ...
  {
    "q": "An IAM role is attached to an Amazon EC2 instance that explicitly denies access to all Amazon S3 API actions. The EC2 instance credentials file specifies the IAM access key and secret access key, which allow full administrative access. Given that multiple modes of IAM access are present for this EC2 instance, which of the following is correct?",
    "options": [
  ...
  {
    "q": "A developer is provided with an HTTPS clone URL for an AWS CodeCommit repository. What needs to be configured before cloning this repository?",
    "options": [
  ...
  {
    "q": "What is required to trace Lambda-based applications with AWS X-Ray?",
    "options": [
  ...
  {
    "q": "A developer converted an existing program to an AWS Lambda function in the console. The program runs properly on a local laptop, but shows an `Unable to import module` error when tested in the Lambda console. Which of the following can fix the error?",
    "options": [
  ...
  {
    "q": "A front-end web application is using Amazon Cognito user pools to handle the user authentication flow. A developer is integrating Amazon DynamoDB into the application using the AWS SDK for JavaScript. How would the developer securely call the API without exposing the access or secret keys?",
    "options": [
  ...
  {
    "q": "A developer needs to manage AWS infrastructure as code and must be able to deploy multiple identical copies of the infrastructure, stage changes, and revert to previous versions. Which approach addresses these requirements?",
    "options": [
  ...
  {
    "q": "A Developer needs to deploy an application running on AWS Fargate using Amazon ECS. The application has environment variables that must be passed to a container for the application to initialize. How should the environment variables be passed to the container?",
    "options": [
  ...
  {
    "q": "A company is managing a NoSQL database on-premises to host a critical component of an application, which is starting to have scaling issues. The company wants to migrate the application to Amazon DynamoDB with the following considerations: Optimize frequent queries. Reduce read latencies. Plan for frequent queries on certain key attributes of the table. Which solution would help achieve these objectives?",
    "options": [
  ...
  {
    "q": "A company is using Amazon API Gateway to manage its public-facing API. The CISO requires that the APIs be used by test account users only. What is the MOST secure way to restrict API access to users of this particular AWS account?",
    "options": [
  ...
  {
    "q": "A company requires that AWS Lambda functions written by Developers log errors so System Administrators can more effectively troubleshoot issues. What should the Developers implement to meet this need?",
    "options": [
  ...
  {
    "q": "A Developer is writing an application that runs on Amazon EC2 instances in an Auto Scaling group. The application data is stored in an Amazon DynamoDB table and records are constantly updated by all instances. An instance sometimes retrieves old data. The Developer wants to correct this by making sure the reads are strongly consistent. How can the Developer accomplish this?",
    "options": [
  ...
  {
    "q": "A Developer has an application that must accept a large amount of incoming data streams and process the data before sending it to many downstream users. Which serverless solution should the Developer use to meet these requirements?",
    "options": [
  ...
  {
    "q": "An application is experiencing performance issues based on increased demand. This increased demand is on read-only historical records pulled from an Amazon RDS-hosted database with custom views and queries. A Developer must improve performance without changing the database structure. Which approach will improve performance and MINIMIZE management overhead?",
    "options": [
  ...
  {
    "q": "A company wants to containerize an existing three-tier web application and deploy it to Amazon ECS Fargate. The application is using session data to keep track of user activities. Which approach would provide the BEST user experience?",
    "options": [
  ...
  {
    "q": "A Developer is investigating an application's performance issues. The application consists of hundreds of microservices, and a single API call can potentially have a deep call stack. The Developer must isolate the component that is causing the issue. Which AWS service or feature should the Developer use to gather information about what is happening and isolate the fault?",
    "options": [
      "AWS X-Ray.",
      "VPC Flow Logs.",
      "Amazon GuardDuty.",
  ...
  {
    "q": "A Company runs continuous integration/continuous delivery (CI/CD) pipelines for its application on AWS CodePipeline. A Developer must write unit tests and run them as part of the pipelines before staging the artifacts for testing. How should the Developer incorporate unit tests as part of CI/CD pipelines?",
    "options": [
  ...
  {
    "q": "A Developer must allow guest users without logins to access an Amazon Cognito-enabled site to view files stored within an Amazon S3 bucket. How should the Developer meet these requirements?",
    "options": [
  ...
  {
    "q": "A Developer has written code for an application and wants to share it with other Developers on the team to receive feedback. The shared application code needs to be stored long-term with multiple versions and batch change tracking. Which AWS service should the Developer use?",
    "options": [
      "AWS CodeBuild.",
      "Amazon S3.",
      "AWS CodeCommit.",
  ...
  {
    "q": "A Developer has discovered that an application responsible for processing messages in an Amazon SQS queue is routinely falling behind. The application is capable of processing multiple messages in one execution, but is only receiving one message at a time. What should the Developer do to increase the number of messages the application receives?",
    "options": [
  ...
  {
    "q": "A Developer registered an AWS Lambda function as a target for an Application Load Balancer (ALB) using a CLI command. However, the Lambda function is not being invoked when the client sends requests through the ALB. Why is the Lambda function not being invoked?",
    "options": [
  ...
  {
    "q": "A company provides APIs as a service and commits to a service level agreement (SLA) with all its users. To comply with each SLA, what should the company do?",
    "options": [
  ...
  {
    "q": "A Developer needs to create an application that supports Security Assertion Markup Language (SAML) and Facebook authentication. It must also allow access to AWS services, such as Amazon DynamoDB. Which AWS service or feature will meet these requirements with the LEAST amount of additional coding?",
    "options": [
      "AWS AppSync.",
  ...
  {
    "q": "A Developer has written an application that runs on Amazon EC2 instances and generates a value every minute. The Developer wants to monitor and graph the values generated over time without logging in to the instance each time. Which approach should the Developer use to achieve this goal?",
    "options": [
  ...
  {
    "q": "A Developer is building a serverless application using AWS Lambda and must create a REST API using an HTTP GET method. What needs to be defined to meet this requirement? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A Developer is writing an application in AWS Lambda. To simplify testing and deployments, the Developer needs the database connection string to be easily changed without modifying the Lambda code. How can this requirement be met?",
    "options": [
  ...
  {
    "q": "A Developer is migrating an on-premises application to AWS. The application currently takes user uploads and saves them to a local directory on the server. All uploads must be saved and made immediately available to all instances in an Auto Scaling group. Which approach will meet these requirements?",
    "options": [
  ...
  {
    "q": "A Developer is building an application that needs to store data in Amazon S3. Management requires that the data be encrypted before it is sent to Amazon S3 for storage. The encryption keys need to be managed by the Security team. Which approach should the Developer take to meet these requirements?",
    "options": [
  ...
  {
    "q": "A Developer has written an Amazon Kinesis Data Streams application. As usage grows and traffic increases over time, the application is regularly receiving `ProvisionedThroughputExceededException` error messages. Which steps should the Developer take to resolve the error? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A Developer is publishing critical log data to a log group in Amazon CloudWatch Logs, which was created 2 months ago. The Developer must encrypt the log data using an AWS KMS customer master key (CMK) so future data can be encrypted to comply with the company's security policy. How can the Developer meet this requirement?",
    "options": [
  ...
  {
    "q": "A Developer has code running on Amazon EC2 instances that needs read-only access to an Amazon DynamoDB table. What is the MOST secure approach the Developer should take to accomplish this task?",
    "options": [
  ...
  {
    "q": "A Developer wants to insert a record into an Amazon DynamoDB table as soon as a new file is added to an Amazon S3 bucket. Which set of steps would be necessary to achieve this?",
    "options": [
  ...
  {
    "q": "A company has implemented AWS CodeDeploy as part of its cloud native CI/CD stack. The company enables automatic rollbacks while deploying a new version of a popular web application from in-place to Amazon EC2. What occurs if the deployment of the new version fails due to code regression?",
    "options": [
  ...
  {
    "q": "A company has implemented AWS CodePipeline to automate its release pipelines. The Development team is writing an AWS Lambda function what will send notifications for state changes of each of the actions in the stages. Which steps must be taken to associate the Lambda function with the event source?",
    "options": [
  ...
  {
    "q": "A Developer has built an application running on AWS Lambda using AWS Serverless Application Model (AWS SAM). What is the correct order of execution to successfully deploy the application?",
    "options": [
  ...
  {
    "q": "A company wants to migrate an imaging service to Amazon EC2 while following security best practices. The images are sourced and read from a non-public Amazon S3 bucket. What should a Developer do to meet these requirements?",
    "options": [
  ...
  {
    "q": "A Development team wants to immediately build and deploy an application whenever there is a change to the source code. Which approaches could be used to trigger the deployment? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A Software Engineer developed an AWS Lambda function in Node.js to do some CPU-intensive data processing. With the default settings, the Lambda function takes about 5 minutes to complete. Which approach should a Developer take to increase the speed of completion?",
    "options": [
  ...
  {
    "q": "A Developer is writing an application that will run on Amazon EC2 instances in an Auto Scaling group. The Developer wants to externalize session state to support the application. Which services will meet these needs? (Choose TWO)",
    "options": [
      "Amazon DynamoDB.",
      "Amazon Cognito.",
      "Amazon ElastiCache.",
  ...
  {
    "q": "A Developer is working on a serverless project based in Java. Initial testing shows a cold start takes about 8 seconds on average for AWS Lambda functions. What should the Developer do to reduce the cold start time? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A Developer has created a new AWS IAM user that has `s3:putObject` permission to write to a specific Amazon S3 bucket. This S3 bucket uses server-side encryption with AWS KMS managed keys (SSE-KMS) as the default encryption. Using the access key and secret key of the IAM user, the application received an access denied error when calling the `PutObject` API. How can this issue be resolved?",
    "options": [
  ...
  {
    "q": "A company has a web application that uses an Amazon Cognito user pool for authentication. The company wants to create a login page with the company logo. What should a Developer do to meet these requirements?",
    "options": [
  ...
  {
    "q": "A Developer is storing sensitive data generated by an application in Amazon S3. The Developer wants to encrypt the data at rest. A company policy requires an audit trail of when the master key was used and by whom. Which encryption option will meet these requirements?",
    "options": [
      "Server-side encryption with Amazon S3 managed keys (SSE-S3).",
      "Server-side encryption with AWS KMS managed keys (SSE-KMS).",
  ...
  {
    "q": "A company's website runs on an Amazon EC2 instance and uses Auto Scaling to scale the environment during peak times. Website users across the world are experiencing high latency due to static content on the EC2 instance, even during non-peak hours. Which combination of steps will resolve the latency issue? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A company is developing a web application that allows its employees to upload a profile picture to a private Amazon S3 bucket. There is no size limit for the profile pictures, which should be displayed every time an employee logs in. For security reasons, the pictures cannot be publicly accessible. What is a viable long-term solution for this scenario?",
    "options": [
  ...
  {
    "q": "A Developer is going to deploy an AWS Lambda function that requires significant CPU utilization. Which approach will MINIMIZE the average runtime of the function?",
    "options": [
  ...
  {
    "q": "A Developer wants to build an application that will allow new users to register and create new user accounts. The application must also allow users with social media accounts to log in using their social media credentials. Which AWS service or feature can be used to meet these requirements?",
    "options": [
      "AWS IAM.",
      "Amazon Cognito identity pools.",
      "Amazon Cognito user pools.",
  ...
  {
    "q": "A company wants to implement authentication for its new REST service using Amazon API Gateway. To authenticate the calls, each request must include HTTP headers with a client ID and user ID. These credentials must be compared to authentication data in an Amazon DynamoDB table. What MUST the company do to implement this authentication in API Gateway?",
    "options": [
  ...
  {
    "q": "A Developer is trying to make API calls using SDK. The IAM user credentials used by the application require multi-factor authentication for all API calls. Which method the Developer use to access the multi-factor authentication protected API?",
    "options": [
      "GetFederationToken.",
      "GetCallerIdentity.",
      "GetSessionToken.",
  ...
  {
    "q": "When developing an AWS Lambda function that processes Amazon Kinesis Data Streams, Administrators within the company must receive a notice that includes the processed data. How should the Developer write the function to send processed data to the Administrators?",
    "options": [
  ...
  {
    "q": "A Developer is storing sensitive documents in Amazon S3 that will require encryption at rest. The encryption keys must be rotated annually, at least. What is the easiest way to achieve this?",
    "options": [
  ...
  {
    "q": "A company is creating a REST service using an Amazon API Gateway with AWS Lambda integration. The service must run different versions for testing purposes. What would be the BEST way to accomplish this?",
    "options": [
  ...
  {
    "q": "A Developer must encrypt a 100-GB object using AWS KMS. What is the BEST approach?",
    "options": [
  ...
  {
    "q": "A Development team would like to migrate their existing application code from a GitHub repository to AWS CodeCommit. What needs to be created before they can migrate a cloned repository to CodeCommit over HTTPS?",
    "options": [
  ...
  {
    "q": "What item operation allows the retrieval of multiple items from a DynamoDB table in a single API call?",
    "options": [
      "`GetItem`.",
      "`BatchGetItem`.",
      "`GetMultipleItems`.",
  ...
  {
    "q": "You attempt to store an object in the `US-STANDARD` region in Amazon S3, and receive a confirmation that it has been successfully stored. You then immediately make another API call and attempt to read this object. S3 tells you that the object does not exist. What could explain this behavior?",
    "options": [
  ...
  {
    "q": "What is the maximum number of S3 Buckets available per AWS account?",
    "options": [
      "100 per region.",
      "there is no limit.",
  ...
  {
    "q": "Which of the following items are required to allow an application deployed on an EC2 instance to write data to a DynamoDB table? Assume that no security Keys are allowed to be stored on the EC2 instance. (Choose TWO)",
    "options": [
  ...
  {
    "q": "Which of the following are correct statements with policy evaluation logic in AWS Identity and Access Management? (Choose TWO)",
    "options": [
  ...
  {
    "q": "If a message is retrieved from a queue in Amazon SQS, how long is the message inaccessible to other users by default?",
    "options": [
      "0 seconds.",
      "1 hour.",
      "1 day.",
  ...
  {
    "q": "When uploading an object, what request header can be explicitly specified in a request to Amazon S3 to encrypt object data when saved on the server side?",
    "options": [
      "`x-amz-storage-class`.",
      "`Content-MD5`.",
  ...
  {
    "q": "Which of the following platforms are supported by Elastic Beanstalk? (Choose TWO)",
    "options": [
      "Apache Tomcat.",
      ".NET.",
      "IBM Websphere.",
  ...
  {
    "q": "Which code snippet below returns the URL of a load balanced web site created in CloudFormation with an `AWS::ElasticLoadBalancing::LoadBalancer` resource name `ElasticLoad Balancer`?",
    "options": [
  ...
  {
    "q": "Which features can be used to restrict access to data in S3? (Choose TWO)",
    "options": [
  ...
  {
    "q": "What happens, by default, when one of the resources in a CloudFormation stack cannot be created?",
    "options": [
  ...
  {
    "q": "Which of the following are valid arguments for an SNS Publish request? (Choose THREE)",
    "options": [
      "TopicArn.",
      "Subject.",
      "Destination.",
  ...
  {
    "q": "How can software determine the public and private IP addresses of the Amazon EC2 instance that it is running on?",
    "options": [
  ...
  {
    "q": "EC2 instances are launched from Amazon Machine images (AMIs). A given public AMI can:",
    "options": [
  ...
  {
    "q": "Which EC2 API call would you use to retrieve a list of Amazon Machine Images (AMIs)?",
    "options": [
      "`DescribeInstances`.",
      "`DescribeAMIs`.",
      "`DescribeImages`.",
  ...
  {
    "q": "In AWS, which security aspects are the customer's responsibility? (Choose FOUR)",
    "options": [
  ...
  {
    "q": "When using a large Scan operation in DynamoDB, what technique can be used to minimize the impact of a scan on a table's provisioned throughput?",
    "options": [
  ...
  {
    "q": "Which of the following is chosen as the default region when making an API call with an AWS SDK?",
    "options": [
      "`ap-northeast-1`.",
      "`us-west-2`.",
      "`us-east-1`.",
  ...
  {
    "q": "Which of the following statements about SWF are true? (Choose THREE)",
    "options": [
  ...
  {
    "q": "Which of the following are valid SNS delivery transports? (Choose TWO)",
    "options": [
      "HTTP.",
      "UDP.",
      "SMS.",
  ...
  {
    "q": "Company C has recently launched an online commerce site for bicycles on AWS. They have a `Product` DynamoDB table that stores details for each bicycle, such as, manufacturer, color, price, quantity and size to display in the online store. Due to customer demand, they want to include an image for each bicycle along with the existing details. Which approach below provides the least impact to provisioned throughput on the `Product` table?",
    "options": [
  ...
  {
    "q": "Which DynamoDB limits can be raised by contacting AWS support? (Choose TWO)",
    "options": [
  ...
  {
    "q": "When a Simple Queue Service message triggers a task that takes 5 minutes to complete, which process below will result in successful processing of the message and remove it from the queue while minimizing the chances of duplicate processing?",
    "options": [
  ...
  {
    "q": "Which of the following is an example of a good DynamoDB hash key schema for provisioned throughput efficiency?",
    "options": [
  ...
  {
    "q": "Which of the following services are included at no additional cost with the use of the AWS platform?",
    "options": [
      "Simple Storage Service.",
  ...
  {
    "q": "Your application is trying to upload a 6 GB file to Simple Storage Service and receive a `Your proposed upload exceeds the maximum allowed object size.` error message. What is a possible solution for this?",
    "options": [
  ...
  {
    "q": "What AWS products and features can be deployed by Elastic Beanstalk? (Choose THREE)",
    "options": [
      "Auto scaling groups.",
  ...
  {
    "q": "Games-R-Us is launching a new game app for mobile devices. Users will log into the game using their existing Facebook account and the game will record player data and scoring information directly to a DynamoDB table. What is the most secure approach for signing requests to the DynamoDB API?",
    "options": [
  ...
  {
    "q": "Which of the following programming languages have an officially supported AWS SDK? (Choose TWO)",
    "options": [
      "Perl.",
      "PHP.",
      "Pascal.",
  ...
  {
    "q": "A meteorological system monitors 600 temperature gauges, obtaining temperature samples every minute and saving each sample to a DynamoDB table Each sample involves writing 1K of data and the writes are evenly distributed over time. How much write throughput is required for the target table?",
    "options": [
  ...
  {
    "q": "In DynamoDB, what type of HTTP response codes indicate that a problem was found with the client request sent to the service?",
    "options": [
  ...
  {
    "q": "An Amazon S3 bucket, `myawsbucket` is configured with website hosting in Tokyo region, what is the region-specific website endpoint?",
    "options": [
  ...
  {
    "q": "You are inserting 1000 new items every second in a DynamoDB table. Once an hour these items are analyzed and then are no longer needed. You need to minimize provisioned throughput, storage, and API calls. Given these requirements, what is the most efficient way to manage these Items after the analysis?",
    "options": [
  ...
  {
    "q": "You have written an application that uses the Elastic Load Balancing service to spread traffic to several web servers. Your users complain that they are sometimes forced to login again in the middle of using your application, after they have already logged in. This is not behavior you have designed. What is a possible solution to prevent this happening?",
    "options": [
  ...
  {
    "q": "You run an ad-supported photo sharing website using S3 to serve photos to visitors of your site. At some point you find out that other sites have been linking to the photos on your site, causing loss to your business. What is an effective method to mitigate this?",
    "options": [
  ...
  {
    "q": "Which statements about DynamoDB are true? (Choose TWO)",
    "options": [
  ...
  {
    "q": "You are providing AWS consulting services for a company developing a new mobile application that will be leveraging Amazon SNS Mobile Push for push notifications. In order to send direct notification messages to individual devices each device registration identifier or token needs to be registered with SNS; however the developers are not sure of the best way to do this. You advise them to:",
    "options": [
  ...
  {
    "q": "You are writing to a DynamoDB table and receive the following exception: `ProvisionedThroughputExceededException`. though according to your Cloudwatch metrics for the table, you are not exceeding your provisioned throughput. What could be an explanation for this?",
    "options": [
  ...
  {
    "q": "Which of the following statements about SQS is true?",
    "options": [
  ...
  {
    "q": "What type of block cipher does Amazon S3 offer for server side encryption?",
    "options": [
      "Triple DES.",
  ...
  {
    "q": "A team of Developers must migrate an application running inside an AWS Elastic Beanstalk environment from a Classic Load Balancer to an Application Load Balancer. Which steps should be taken to accomplish the task using the AWS Management Console?",
    "options": [
  ...
  {
    "q": "A company needs a version control system for collaborative software development. Features of the system must include the following: Support for batches of changes across multiple files. Parallel branching Version tracking. Which AWS service will meet these requirements?",
    "options": [
      "AWS CodePipeline.",
      "Amazon S3.",
      "AWS Code Build.",
  ...
  {
    "q": "A company is using continuous integration and continuous delivery systems. A Developer now needs to automate a software package deployment to both Amazon EC2 instances and virtual servers running on-premises. Which AWS service should be used to accomplish this?",
    "options": [
      "AWS CodePipeline.",
      "AWS CodeBuild.",
  ...
  {
    "q": "A Developer created a new AWS account and must create a scalable AWS Lambda function that meets the following requirements for concurrent execution: Average execution time of 100 seconds 50 requests per second. Which step must be taken prior to deployment to prevent errors?",
    "options": [
  ...
  {
    "q": "A company runs an e-commerce website that uses Amazon DynamoDB where pricing for items is dynamically updated in real time. At any given time, multiple updates may occur simultaneously for pricing information on a particular product. This is causing the original editor's changes to be overwritten without a proper review process. Which DynamoDB write option should be selected to prevent this overwriting?",
    "options": [
      "Concurrent writes.",
      "Conditional writes.",
      "Atomic writes.",
  ...
  {
    "q": "A Developer has been asked to create an AWS Lambda function that is triggered any time updates are made to items in an Amazon DynamoDB table. The function has been created, and appropriate permissions have been added to the Lambda execution role. Amazon DynamoDB streams have been enabled for the table, but the function is still not being triggered. Which option would enable DynamoDB table updates to trigger the Lambda function?",
    "options": [
  ...
  {
    "q": "A company is running a Docker application on Amazon ECS. The application must scale based on user load in the last 15 seconds. How should a Developer instrument the code so that the requirement can be met?",
    "options": [
  ...
  {
    "q": "A company needs to ingest terabytes of data each hour from thousands of sources that are delivered almost continually throughout the day. The volume of messages generated varies over the course of the day. Messages must be delivered in real time for fraud detection and live operational dashboards. Which approach will meet these requirements?",
    "options": [
  ...
  {
    "q": "A Developer accesses AWS CodeCommit over SSH. The SSH keys configured to access AWS CodeCommit are tied to a user with the following permissions. The Developer needs to create/delete branches. Which specific IAM permissions need to be added, based on the principle of least privilege?",
    "options": [
  ...
  {
    "q": "An AWS Lambda function must access an external site by using a regularly rotated user name and password. These items must be kept securely and cannot be stored in the function code. What combination of AWS services can be used to accomplish this? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A Developer is trying to deploy a serverless application using AWS CodeDeploy. The application was updated and needs to be redeployed. What file does the Developer need to update to push that change through CodeDeploy?",
    "options": [
      "`dockerrun.aws.json`.",
      "`buildspec.yml`.",
      "`appspec.yml`.",
  ...
  {
    "q": "A Developer is working on an application that handles 10MB documents that contain highly-sensitive data. The application will use AWS KMS to perform clientside encryption. What steps must be followed?",
    "options": [
  ...
  {
    "q": "A company needs to distribute firmware updates to its customers around the world. Which service will allow easy and secure control of the access to the downloads at the lowest cost?",
    "options": [
  ...
  {
    "q": "An application writes items to an Amazon DynamoDB table. As the application scales to thousands of instances, calls to the DynamoDB API generate occasional `ThrottlingException` errors. The application is coded in a language incompatible with the AWS SDK. How should the error be handled?",
    "options": [
  ...
  {
    "q": "An e-commerce web application that shares session state on-premises is being migrated to AWS. The application must be fault tolerant, natively highly scalable, and any service interruption should not affect the user experience. What is the best option to store the session state?",
    "options": [
  ...
  {
    "q": "A Developer is creating a template that uses AWS CloudFormation to deploy an application. This application is serverless and uses Amazon API Gateway, Amazon DynamoDB, and AWS Lambda. Which tool should the Developer use to define simplified syntax for expressing serverless resources?",
    "options": [
  ...
  {
    "q": "A Developer has a stateful web server on-premises that is being migrated to AWS. The Developer must have greater elasticity in the new design. How should the Developer re-factor the application to make it more elastic? (Choose TWO)",
    "options": [
  ...
  {
    "q": "A Developer must analyze performance issues with production-distributed applications written as AWS Lambda functions. These distributed Lambda applications invoke other components that make up the applications. How should the Developer identify and troubleshoot the root cause of the performance issues in production?",
    "options": [
  ...
  {
    "q": "A Developer wants to debug an application by searching and filtering log data. The application logs are stored in Amazon CloudWatch Logs. The Developer creates a new metric filter to count exceptions in the application logs. However, no results are returned from the logs. What is the reason that no filtered results are being returned?",
    "options": [
  ...
  {
    "q": "To include objects defined by the AWS Serverless Application Model (SAM) in an AWS CloudFormation template, in addition to `Resources`, what section MUST be included in the document root?",
    "options": [
      "`Conditions`.",
      "`Globals`.",
      "`Transform`.",
  ...
  {
    "q": "A company is using Amazon RDS MySQL instances for its application database tier and Apache Tomcat servers for its web tier. Most of the database queries from web applications are repeated read requests. Use of which AWS service would increase in performance by adding in-memory store for repeated read queries?",
    "options": [
      "Amazon RDS Multi-AZ.",
      "Amazon SQS.",
      "Amazon ElastiCache.",
  ...
  {
    "q": "A Developer has created a Lambda function and is finding that the function is taking longer to complete than expected. After some debugging, the Developer has discovered that increasing compute capacity would improve performance. How can the Developer increase the Lambda compute resources?",
    "options": [
  ...
  {
    "q": "A Developer is writing a mobile application that allows users to view images from an S3 bucket. The users must be able to log in with their Amazon login, as well as Facebook and/or Google accounts. How can the Developer provide this authentication functionality?",
    "options": [
  ...
  {
    "q": "A Developer wants access to make the log data of an application running on an EC2 instance available to systems administrators. Which of the following enables monitoring of this metric in Amazon CloudWatch?",
    "options": [
  ...
  {
    "q": "A nightly batch job loads 1 million new records into a DynamoDB table. The records are only needed for one hour, and the table needs to be empty by the next night's batch job. Which is the MOST efficient and cost-effective method to provide an empty table?",
    "options": [
  ...
  {
    "q": "A company has an application that logs all information to Amazon S3. Whenever there is a new log file, an AWS Lambda function is invoked to process the log files. The code works, gathering all of the necessary information. However, when checking the Lambda function logs, duplicate entries with the same request ID are found. What is causing the duplicate entries?",
    "options": [
  ...
  {
    "q": "A Developer is creating a serverless website with content that includes HTML files, images, videos, and JavaScript (client-side scripts). Which combination of services should the Developer use to create the website?",
    "options": [
  ...
  {
    "q": "A company is creating an application that will require users to access AWS services and allow them to reset their own passwords. Which of the following would allow the company to manage users and authorization while allowing users to reset their own passwords?",
    "options": [
  ...
  {
    "q": "A company has three different environments: Development, QA, and Production. The company wants to deploy its code first in the Development environment, then QA, and then Production. Which AWS service can be used to meet this requirement?",
    "options": [
  ...
  {
    "q": "A company uses Amazon DynamoDB for managing and tracking orders. The DynamoDB table is partitioned based on the order date. The company receives a huge increase in orders during a sales event, causing DynamoDB writes to throttle, and the consumed throughput is far below the provisioned throughput. According to AWS best practices, how can this issue be resolved with MINIMAL costs?",
    "options": [
  ...
  {
    "q": "In a multi-container Docker environment in AWS Elastic Beanstalk, what is required to configure container instances in the environment?",
    "options": [
  ...
  {
    "q": "An application that runs on an Amazon EC2 instance needs to access and make API calls to multiple AWS services. What is the MOST secure way to provide access to the AWS services with MINIMAL management overhead?",
    "options": [
  ...
  {
    "q": "A company is developing an application that will run on several Amazon EC2 instances in an Auto Scaling group and can access a database running on Amazon EC2. The application needs to store secrets required to connect to the database. The application must allow for periodic secret rotation, and there should be no changes to the application when a secret changes. What is the SAFEST way to meet these requirements?",
    "options": [
  ...
  {
    "q": "A Developer writes an AWS Lambda function and uploads the code in a `.ZIP` file to Amazon S3. The Developer makes changes to the code and uploads a new `.ZIP` file to Amazon S3. However, Lambda executes the earlier code. How can the Developer fix this in the LEAST disruptive way?",
    "options": [
  ...
  {
    "q": "An AWS Lambda function must read data from an Amazon RDS MySQL database in a VPC and also reach a public endpoint over the internet to get additional data. Which steps must be taken to allow the function to access both the RDS resource and the public endpoint? (Select TWO)",
    "options": [
  ...
  {
    "q": "A Developer wants to enable AWS X-Ray for a secure application that runs in an Amazon ECS environment. What combination of steps will enable X-Ray? (Select THREE)",
    "options": [
  ...
  {
    "q": "A Developer is designing a new application that uses Amazon S3. To satisfy compliance requirements, the Developer must encrypt the data at rest. How can the Developer accomplish this?",
    "options": [
  ...
  {
    "q": "An AWS Elastic Beanstalk application needs to be deployed in multiple regions and requires a different Amazon Machine Image (AMI) in each region. Which AWS CloudFormation template key can be used to specify the correct AMI for each region?",
    "options": [
      "`Parameters`.",
      "`Outputs`.",
      "`Mappings`.",
  ...
  {
    "q": "A Developer wants to find a list of items in a global secondary index from an Amazon DynamoDB table. Which DynamoDB API call can the Developer use in order to consume the LEAST number of read capacity units?",
    "options": [
  ...
  {
    "q": "A Developer has published an update to an application that is served to a global user base using Amazon CloudFront. After deploying the application, users are not able to see the updated changes. How can the Developer resolve this issue?",
    "options": [
  ...
  {
    "q": "A Developer must deploy a new AWS Lambda function using an AWS CloudFormation template. Which procedures will deploy a Lambda function? (Select TWO)",
    "options": [
  ...
  {
    "q": "How should custom libraries be utilized in AWS Lambda?",
    "options": [
  ...
  {
    "q": "A company needs to secure its existing website running behind an Elastic Load Balancer. The website's Amazon EC2 instances are CPU-constrained. What should be done to secure the website while not increasing the CPU load on the EC2 web servers? (Select TWO)",
    "options": [
  ...
  {
    "q": "A Developer is writing an imaging micro service on AWS Lambda. The service is dependent on several libraries that are not available in the Lambda runtime environment. Which strategy should the Developer follow to create the Lambda deployment package?",
    "options": [
  ...
  {
    "q": "A Developer is designing a fault-tolerant environment where client sessions will be saved. How can the Developer ensure that no sessions are lost if an Amazon EC2 instance fails?",
    "options": [
  ...
  {
    "q": "A Developer is writing a serverless application that requires that an AWS Lambda function be invoked every 10 minutes. What is an automated and serverless way to trigger the function?",
    "options": [
  ...
  {
    "q": "A Developer is creating a mobile application that will not require users to log in. What is the MOST efficient method to grant users access to AWS resources?",
    "options": [
  ...
  {
    "q": "An application running on Amazon EC2 instances must access objects within an Amazon S3 bucket that are encrypted using server-side encryption using AWS KMS encryption keys (SSE-KMS). The application must have access to the customer master key (CMK) to decrypt the objects. Which combination of steps will grant the application access? (Select TWO)",
    "options": [
  ...
  {
    "q": "What does an Amazon SQS delay queue accomplish?",
    "options": [
  ...
  {
    "q": "A company recently migrated its web, application and NoSQL database tiers to AWS. The company is using Auto Scaling to scale the web and application tiers. More than 95 percent of the Amazon DynamoDB requests are repeated read requests. How can the DynamoDB NoSQL tier be scaled up to cache these repeated requests?",
    "options": [
      "Amazon EMR.",
      "Amazon DynamoDB Accelerator.",
      "Amazon SQS.",
  ...
  {
    "q": "A Development team is working on a case management solution that allows medical claims to be processed and reviewed. Users log in to provide information related to their medical and financial situations. As part of the application, sensitive documents such as medical records, medical imaging, bank statements, and receipts are uploaded to Amazon S3. All documents must be securely transmitted and stored. All access to the documents must be recorded for auditing. What is the MOST secure approach?",
    "options": [
  ...
  {
    "q": "A Developer is using AWS CLI, but when running list commands on a large number of resources, it is timing out. What can be done to avoid this time-out?",
    "options": [
      "Use pagination.",
  ...
  {
    "q": "Where can PortMapping be defined when launching containers in Amazon ECS?",
    "options": [
      "Security groups.",
  ...
  {
    "q": "While developing an application that runs on Amazon EC2 in an Amazon VPC, a Developer identifies the need for centralized storage of application-level logs. Which AWS service can be used to securely store these logs?",
    "options": [
  ...
  {
    "q": "A stock market monitoring application uses Amazon Kinesis for data ingestion. During simulated tests of peak data rates, the Kinesis stream cannot keep up with the incoming data. What step will allow Kinesis to accommodate the traffic during peak hours?",
    "options": [
  ...
  {
    "q": "A company has an AWS CloudFormation template that is stored as a single file. The template is able to launch and create a full infrastructure stack. Which best practice would increase the maintainability of the template?",
    "options": [
  ...
  {
    "q": "An on-premises application makes repeated calls to store files to Amazon S3. As usage of the application has increased, `LimitExceeded` errors are being logged. What should be changed to fix this error?",
    "options": [
      "Implement exponential backoffs in the application.",
  ...
  {
    "q": "A company caches session information for a web application in an Amazon DynamoDB table. The company wants an automated way to delete old items from the table. What is the simplest way to do this?",
    "options": [
  ...
  {
    "q": "An application is expected to process many files. Each file takes four minutes to process each AWS Lambda invocation. The Lambda function does not return any important data. What is the fastest way to process all the files?",
    "options": [
  ...
  {
    "q": "The upload of a 15 GB object to Amazon S3 fails. The error message reads: `Your proposed upload exceeds the maximum allowed object size.`. What technique will allow the Developer to upload this object?",
    "options": [
  ...
  {
    "q": "A web application is designed to allow new users to create accounts using their email addresses. The application will store attributes for each user, and is expecting millions of user to sign up. What should the Developer implement to achieve the design goals?",
    "options": [
      "Amazon Cognito user pools.",
  ...
  {
    "q": "An application is using Amazon DynamoDB as its data store, and should be able to read 100 items per second as strongly consistent reads. Each item is 5 KB in size. To what value should the table's provisioned read throughput be set?",
    "options": [
  ...
  {
    "q": "An application uses Lambda functions to extract metadata from files uploaded to an S3 bucket; the metadata is stored in Amazon DynamoDB. The application starts behaving unexpectedly, and the Developer wants to examine the logs of the Lambda function code for errors. Based on this system configuration, where would the Developer find the logs?",
    "options": [
      "Amazon S3.",
      "AWS CloudTrail.",
      "Amazon CloudWatch.",
  ...
  {
    "q": "A Developer is creating a Lambda function that will generate and export a file. The function requires 100 MB of temporary storage for temporary files while executing. These files will not be needed after the function is complete. How can the Developer MOST efficiently handle the temporary files?",
    "options": [
  ...
  {
    "q": "A Developer has developed a web application and wants to deploy it quickly on a Tomcat server on AWS. The Developer wants to avoid having to manage the underlying infrastructure. What is the easiest way to deploy the application, based on these requirements?",
    "options": [
      "AWS CloudFormation.",
      "AWS Elastic Beanstalk.",
      "Amazon S3.",
  ...
  {
    "q": "An application runs on multiple EC2 instances behind an ELB. Where is the session data best written so that it can be served reliably across multiple requests?",
    "options": [
  ...
  {
    "q": "According to best practice, how should access keys be managed in AWS? (Choose TWO)",
    "options": [
  ...
  {
    "q": "An application running on an Amazon Linux EC2 instance needs to manage the AWS infrastructure. How can the EC2 instance be configured to make AWS API calls securely?",
    "options": [
  ...
  {
    "q": "An application needs to use the IP address of the client in its processing. The application has been moved into AWS and has been placed behind an Application Load Balancer (ALB). However, all the client IP addresses now appear to be the same. The application must maintain the ability to scale horizontally. Based on this scenario, what is the MOST cost-effective solution to this problem?",
    "options": [
  ...
  {
    "q": "A development team is using AWS Elastic Beanstalk to deploy a two-tier application that consists of a load-balanced web tier and an Amazon RDS database tier in production. The team would like to separate the RDS instance from the Elastic Beanstalk. How can this be accomplished?",
    "options": [
  ...
  {
    "q": "A social media company is using Amazon Cognito in order to synchronize profiles across different mobile devices, to enable end users to have a seamless experience. Which of the following configurations can be used to silently notify users whenever an update is available on all other devices?",
    "options": [
  ...
  {
    "q": "An on-premises application is implemented using a Linux, Apache, MySQL and PHP (LAMP) stack. The Developer wants to run this application in AWS. Which of the following sets of AWS services can be used to run this stack?",
    "options": [
  ...
  {
    "q": "An application displays a status dashboard. The status is updated by 1 KB messages from an SQS queue. Although the status changes infrequently, the Developer must minimize the time between the message arrival in the queue and the dashboard update. What technique provides the shortest delay in updating the dashboard?",
    "options": [
  ...
  {
    "q": "An on-premises legacy application is caching data files locally and writing shared images to local disks. What is necessary to allow for horizontal scaling when migrating the application to AWS?",
    "options": [
  ...
  {
    "q": "A Developer must trigger an AWS Lambda function based on the item lifecycle activity in an Amazon DynamoDB table. How can the Developer create the solution?",
    "options": [
  ...
  {
    "q": "After installing the AWS CLI, a Developer tries to run the command `aws configure` but receives the following error: `Error: aws: command not found`. What is the most likely cause of this error?",
    "options": [
  ...
  {
    "q": "When a Developer tries to run an AWS CodeBuild project, it raises an error because the length of all environment variables exceeds the limit for the combined maximum of characters. What is the recommended solution?",
    "options": [
  ...
  {
    "q": "A set of APIs are exposed to customers using the Amazon API Gateway. These APIs have caching enabled on the API Gateway. Customers have asked for an option to invalidate this cache for each of the APIs. What action can be taken to allow API customers to invalidate the API Cache?",
    "options": [
  ...
  {
    "q": "A Developer must repeatedly and consistently deploy a serverless RESTful API on AWS. Which techniques will work? (Choose TWO)",
    "options": [
  ...
  {
    "q": "An existing serverless application processes uploaded image files. The process currently uses a single Lambda function that takes an image file, performs the processing, and stores the file in Amazon S3. Users of the application now require thumbnail generation of the images. Users want to avoid any impact to the time it takes to perform the image uploads. How can thumbnail generation be added to the application, meeting user requirements while minimizing changes to existing code?",
    "options": [
  ...
  {
    "q": "A company is using Amazon API Gateway to manage access to a set of microservices implemented as AWS Lambda functions. Following a bug report, the company makes a minor breaking change to one of the APIs. In order to avoid impacting existing clients when the new API is deployed, the company wants to allow clients six months to migrate from v1 to v2. Which approach should the Developer use to handle this change?",
    "options": [
  ...
  {
    "q": "Where should an Elastic Beanstalk configuration file named `healthcheckur1.config` be placed in the application source bundle?",
    "options": [
  ...
  {
    "q": "A static website is hosted in an Amazon S3 bucket. Several HTML pages on the site use JavaScript to download images from another Amazon S3 bucket. These images are not displayed when users browse the site. What is the possible cause for the issue?",
    "options": [
  ...
  {
    "q": "Amazon S3 has the following structure: `S3://BUCKET/FOLDERNAME/FILENAME.zip`. Which S3 best practice would optimize performance with thousands of PUT request each second to a single bucket?",
    "options": [
  ...
  {
    "q": "What does Amazon SQS provide? A. B. C. D. An asynchronous message queue service.",
    "options": [
      "Simple Query Server, managed directly by Amazon Web Services. None of these.",
      "synchronous message queue service."
    ],
    "answer": 1
  },
  {
  ...
  {
    "q": "Which of the following are valid SNS delivery transports? Choose 2 answers",
    "options": [
      "HTTP",
      "UDP",
      "SMS",
  ...
  {
    "q": "An orgAMzation has hosted an application on the EC2 instances. There will be multiple users connecting to the instance for setup and configuration of application. The orgAMzation is planning to implement certain security best practices. Which of the below mentioned pointers will not help the orgAMzation achieve better security arrangement?",
    "options": [
      ...
      "Disable the password based login for all the user",
      "All the users should use their own keys to connect with the instance securely.",
      "Create a procedure to revoke the access rights of the indMdual user when they are not required to connect to EC2 instance anymore for the purpose of application configuration."
    ],
    "answer": 1
  },
  {
    "q": "True or False: In DynamoDB, Scan operations are always eventually consistent.",
    "options": [
      "No, scan is like Query operation",
      "Yes",
      "No, scan is strongly consistent by default",
      "No, you can optionally request strongly consistent sca"
    ],
    "answer": 1
  },
  {
    "q": "Regarding Amazon SNS, when you want to subscribe to a topic and receive notifications to your email, in the Protocol drop-down box, you should select .",
    "options": [
      "Email",
      "Message",
      "SMTP",
  ...
  {
    "q": "In DynamoDB, to get a detailed listing of secondary indexes on a table, you can use the action.",
    "options": [
      "DescribeTabIe",
      "BatchGetItem",
      "Getltem",
  ...
  {
    "q": "Regarding Amazon SNS, you can send notification messages to mobile devices through any of the following supported push notification services, EXCEPT:",
    "options": [
  ...
  {
    "q": "Regarding Amazon SNS, to begin using Amazon SNS mobile push notifications, you first need that uses one of the supported push notification services: APNS, GCM, or ADM.",
    "options": [
      ...
      "an app for the mobile endpoints"
    ],
    "answer": 3
  },
  {
    "q": "In regard to DynamoDB, can I delete local secondary indexes?",
    "options": [
      "Yes, if it is a primary hash key index",
      "No",
      "Yes, if it is a local secondary indexes",
      "Yes, if it is a Global secondary indexes"
    ],
    "answer": 1
  },
  {
    "q": "You need to develop and run some new applications on AWS and you know that Elastic Beanstalk and CIoudFormation can both help as a deployment mechAMsm for a broad range of AWS resources. Which of the following statements best describes the differences between Elastic Beanstalk and C|oudFormation?",
    "options": [
      "Elastic Beanstalk uses Elastic load balancing and CIoudFormation doesn't.",
      "CIoudFormation is faster in deploying applications than Elastic Beanstalk.",
      "CIoudFormation is much more powerful than Elastic Beanstalk, because you can actually design and script custom resources",
      "Elastic Beanstalk is faster in deploying applications than C|oudFormatio"
    ],
    "answer": 2
  },
  {
    "q": "How can a user configure three termination policies for the AutoScaIing group?",
    "options": [
      "Define multiple policies in random order",
      "Define multiple policies in the ordered list",
      "Keep updating the AutoScaIing group with each policy",
      "The user cannot specify more than two policies for AutoScaIing"
    ],
    "answer": 1
  },
  {
    "q": "When using Amazon SQS how much data can you store in a message?",
    "options": [
      "8 KB",
      "2 KB",
      "16 KB",
  ...
  },
  {
    ...
    "options": [
      ...
      "The orgAMzation should provide a MAC address as a part of the user dat F. Thus, whenever the instance is booted the script assigns the fixed MAC address to that instance."
    ],
    "answer": 1
  },
  {
    "q": "An orgAMzation has 10000 employees. The orgAMzation wants to give restricted AWS access to each employee. How can the orgAMzation achieve this?",
    "options": [
  ...
  {
    "q": "Can a user associate and use his own DNS with ELB instead ofthe DNS provided by AWS ELB?",
    "options": [
      "Yes, by creating a CNAME with the existing domain name provider",
  ...
  {
    "q": "You are using Amazon SQS and are getting a \"Queue Deleted RecentIy\" error. What is wrong?",
    "options": [
  ...
  {
    "q": "True or False: AWS CIoudFormation allows you to create Microsoft Windows stacks.",
    "options": [
      "False, AWS CIoudFormation does not support Microsoft Windows.",
  ...
  {
    "q": "When a user is launching an instance with EC2, which of the below mentioned options is not available during the instance launch console for a key pair?",
    "options": [
  ...
  {
    "q": "When working with AWS CIoudFormation Templates what is the maximum number of stacks that you can create?",
    "options": [
      "500",
      "50",
      "20",
  ...
  {
    "q": "Which DynamoDB limits can be raised by contacting AWS support? Choose 2 answers",
    "options": [
      "The number of hash keys per account",
      "The maximum storage used per account",
      "The number of tables per account",
  ...
  {
    "q": "Which features can be used to restrict access to data in S3? Choose 2 answers",
    "options": [
      "Use S3 Virtual Hosting",
      "Set an S3 Bucket policy.",
      "Enable IAM Identity Federation.",
      "Set an S3 ACL on the bucket or the object.",
      "Create a C|oudFront distribution for the bucket"
    ],
    "answer": [
      2,
      3
  ...
  {
    "q": "What happens, by default, when one of the resources in a CIoudFormation stack cannot be created?",
    "options": [
      "Previously-created resources are kept but the stack creation terminates.",
      "Previously-created resources are deleted and the stack creation terminates.",
      "The stack creation continues, and the final results indicate which steps failed.",
      "CIoudFormation templates are parsed in advance so stack creation is guaranteed to succee"
    ],
    "answer": 1
  },
  {
    "q": "An orgAMzation has 500 employees. The orgAMzation wants to set up AWS access for each department. Which of the below mentioned options is a possible solution?",
    "options": [
      "Create IAM roles based on the permission and assign users to each role",
      "Create IAM users and provide indMdual permission to each",
  ...
  {
    "q": "In Amazon EC2, which of the following is the type of monitoring data for Amazon EBS volumes that is available automatically in 5-minute periods at no charge?",
    "options": [
      "Primary",
      "Basic",
      "Initial",
  ...
  {
    "q": "is a task coordination and state management service for cloud applications.",
    "options": [
      "Amazon SES",
      "Amazon SWF",
      "Amazon FPS",
  ...
  {
    "q": "Can a user get a notification of each instance start / terminate configured with Auto Scaling?",
    "options": [
      "Yes, always",
      "No",
  ...
  {
    "q": "Can you SSH to your private machines that reside in a VPC from outside without elastic IP?",
    "options": [
      "Yes, but only if you have direct connect or vpn",
  ...
  {
    "q": "Is there a limit to how much throughput you can get out of a single table in DynamoDB?",
    "options": [
      "Yes, not more than 1,000 writes/second or 1,000 reads/second",
      "No",
  ...
  {
    "q": "In AWS Elastic Beanstalk, you can update your deployed application even while it is part of a running environment. For a Java application, you can also use to update your deployed application.",
    "options": [
      "the AWS Toolkit for Eclipse",
      "the AWS Toolkit for Visual Studio",
      "the AWS Toolkit for JVM",
      "the AWS Toolkit for Netbeans"
    ],
    "answer": 0
  },
  {
    "q": "can be used to bootstrap both the Chef Server and Chef Client software on your EC2 instances.",
    "options": [
      "AWS CIoudFormation",
      "AWS Elastic Beanstalk",
      "AWS OpsWorks",
  ...
  {
    "q": "When you register an actMty in Amazon SWF, you provide the following information, except:",
    "options": [
      "a name",
      "timeout values",
      "a domain",
  ...
  {
    "q": "Your manager has requested you to tag EC2 instances to orgAMze and manage a load balancer. Which of the following statements about tag restrictions is incorrect?",
    "options": [
  ...
  {
    "q": "An orgAMzation has enabled a strict password policy for its IAM users. The orgAMzation is taking help from the IAM console to set the password policy. Which of the below mentioned rules cannot be specified by the user as a part of the policy?",
    "options": [
  ...
  {
    "q": "An orgAMzation has created 10 IAM users. The orgAMzation wants those users to work independently and access AWS. Which of the below mentioned options is not a possible solution?",
    "options": [
  ...
  {
    "q": "To scale up the AWS resources using manual AutoScaIing, which of the below mentioned parameters should the user change?",
    "options": [
      "Maximum capacity",
      "Desired capacity",
      "Preferred capacity",
  ...
  {
    "q": "Which one of the following data types does Amazon DynamoDB not support?",
    "options": [
      "Arrays",
      "String",
      "Binary",
  ...
  {
    "q": "Does AWS CIoudFormation support Amazon EC2 tagging?",
    "options": [
  ...
  {
    "q": "When you use the AWS Elastic Beanstalk console to deploy a new application you’II need to upload a source bundle and it should .",
    "options": [
  ...
  {
    "q": "What does Amazon SQS provide?",
    "options": [
      "An asynchronous message queue service.",
      "A Simple Query Sewer, managed directly by Amazon Web Services.",
      "None of these.",
  ...
  {
    "q": "An orgAMzation has 20 employees. The orgAMzation wants to give all the users access to the orgAMzation AWS account. Which of the below mentioned options is the right solution?",
    "options": [
      ...
      "Use the IAM role to allow access based on STS"
    ],
    "answer": 1
  },
  {
    "q": "ExamKiIIer (with AWS account ID 111122223333) has created 50 IAM users for its orgAMzation’s employees. What will be the AWS console URL for these associates?",
    "options": [
      "https:// 111122223333.signin.aws.amazon.com/conso|e/",
      "https:// signin.aws.amazon.com/consoIe/",
      "https://signin.aws.amazon.com/111122223333/conso|e/",
  ...
  {
    "q": "In DynamoDB, the default table size is:",
    "options": [
      "5 GB",
      "1 GB",
      "10 GB",
  ...
  {
    "q": "An orgAMzation is setting up their website on AWS. The orgAMzation is working on various security measures to be performed on the AWS EC2 instances. Which of the below mentioned security mechAMsms will not help the orgAMzation to avoid future data leaks and identify security weaknesses?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "Use the IAM based single sign between the AWS resources and the orgAMzation applicatio"
    ],
    "answer": 0
  },
  {
    ...
    "options": [
      "www.myawsbucket.ap-northeast-1.amazonaws.com",
      "myawsbucket.s3-website-ap-northeast-I.amazonawscom",
      "myawsbucket.amazonaws.com",
      "myawsbucket.tokyo.amazonaws.com"
    ],
    "answer": 1
  ...
  {
    "q": "Is it possible to create an S3 bucket accessible only by a certain IAM user, using policies in a C|oudFormation template?",
    "options": [
      "No, you can only create the S3 bucket but not the IAM user.",
      "S3 is not supported by CIoudFormation.",
      "Yes, all these resources can be created using a CIoudFormation template",
      "No, in the same template you can only create the S3 bucket and the realtive polic"
    ],
    "answer": 2
  },
  {
    "q": "In relation to Amazon Simple Workflow Service (Amazon SWF),what is an \"ActMty Worker\"?",
    "options": [
      "An indMdual task undertaken by a workflow",
      "The automation of a business process",
      "A piece of software that implements tasks",
      "All answers listed are correct"
    ],
    "answer": 2
  },
  {
    "q": "When AutoScaIing is launching a new instance based on condition, which of the below mentioned policies will it follow?",
    "options": [
  ...
  {
    "q": "An orgAMzation has 10 departments. The orgAMzation wants to track the AWS usage of each department. Which of the below mentioned options meets the requirement?",
    "options": [
  ...
  {
    "q": "Which of the following statements about SWF are true? Choose 3 answers",
    "options": [
      "SWF tasks are assigned once and never duplicated",
      "SWF requires an S3 bucket for workflow storage",
      "SWF workflow executions can last up to a year",
      "SWF triggers SNS notifications on task assignment",
      "SWF uses deciders and workers to complete tasks F. SWF requires atleast 1 EC2 instance per domain"
    ],
    "answer": [
      0,
      2,
  ...
  {
    "q": "When a user is detaching an EBS volume from a running instance and attaching it to a new instance, which of the below mentioned options should be followed to avoid file system damage?",
    "options": [
  ...
  {
    "q": "AutoScaIing is configured with 3 AZs. Each zone has 5 instances running. If AutoScaIing wants to terminate an instance based on the policy action, which instance will it terminate first?",
    "options": [
      ...
      "Terminate the instance from the AZ which has instances running near to the billing hour"
    ],
    "answer": 1
  },
  {
    "q": "When should a user try to Force Detach an EBS volume?",
    "options": [
      "If the volume is stuck in a detaching state",
  ...
  {
    "q": "An orgAMzation is hosting an application as part of the free usage tier. The orgAMzation wants to create IAM users for each of its 150 employees and they may access AWS as part of free usage tier. What will you advise the orgAMzation?",
    "options": [
      "The IAM is not available as a part of the free usage tier",
      "Create IAM roles and give access based on role since it will not cost the user",
      "Do not create more than 100 users as it will cost the orgAMzation.",
      "Create IAM users for each employee as it does not cost"
    ],
    "answer": 3
  },
  {
    "q": "When you use the AWS Elastic Beanstalk console to deploy a new application .",
    "options": [
      "you’II need to upload each file separately",
      "you’II need to create each file and path",
      "you’II need to upload a source bundle",
      "you’II need to create each file"
    ],
    "answer": 2
  },
  {
    "q": "ExamKiIIer has three AWS accounts. They have created separate IAM users within each account. ExamKiIIer wants a single IAM console URL such as https://examkiIIer.signin.aws.amazon.com/consoIe/ for all account users. How can this be achieved?",
    "options": [
  ...
  {
    "q": "An orgAMzation has launched two applications: one for blogging and one for ECM on the same AWS Linux EC2 instance running in the AWS VPC. The orgAMzation has attached two private IPs (primary and secondary) to the above mentioned instance. The orgAMzation wants the instance OS to recognize the secondary IP address. How can the orgAMzation configure this?",
    "options": [
  ...
  {
    "q": "You have a number of image files to encode. In an Amazon SQS worker queue, you create an Amazon SQS message for each file specifying the command (jpegencode) and the location of the file in Amazon S3. Which of the following statements best describes the functionality of Amazon SQS?",
    "options": [
      "Amazon SQS is for single-threaded sending or receMng speeds.",
      "Amazon SQS is a non-distributed queuing system.",
      "Amazon SQS is a distributed queuing system that is optimized for horizontal scalability, not for single-threaded sending or receMng speeds.",
      "Amazon SQS is a distributed queuing system that is optimized for vertical scalability and for single-threaded sending or receMng speeds."
    ],
    "answer": 2
  },
  {
    "q": "The user has configured AutoScaIing based on the dynamic policy. Which of the following is not the right command to specify a change in capacity as a part of the policy?",
    "options": [
  ...
  {
    "q": "In regard to AWS CIoudFormation, what is a stack?",
    "options": [
  ...
  {
    "q": "An application stores user sessions in Amazon DynamoDB. When a user's data is modified, a downstream service needs to be notified in near real-time to update a search index. Which solution meets this requirement with the LEAST operational overhead?",
    "options": [
      "Poll the DynamoDB table every minute with a Lambda function",
      "Enable DynamoDB Streams and trigger a Lambda function to process the stream records",
      "Use Amazon SNS to publish updates whenever the application writes to DynamoDB",
      "Use DynamoDB transactions and trigger an EventBridge event from the application code"
    ],
    "answer": 1,
    "topic": "DynamoDB"
  },
  {
    "q": "A team has several Lambda functions that all share the same 10 MB Python library. To avoid re-uploading the library with each deployment, what is the BEST approach?",
    "options": [
      "Package the library inside each Lambda function ZIP separately",
      "Include the library in the Lambda execution environment using an environment variable",
      "Create a Lambda Layer containing the library and attach it to each function",
      "Upload the library to S3 and reference it each time the Lambda is invoked"
    ],
    "answer": 2,
    "topic": "Lambda"
  },
  {
    "q": "An SQS consumer application processes a message but fails to complete within the visibility timeout period. What happens to the message?",
    "options": [
      "The message is permanently deleted from the queue",
      "The message is moved to the Dead Letter Queue immediately",
      "The message becomes visible again and can be consumed by another consumer",
      "The message is archived in Amazon S3"
    ],
    "answer": 2,
    "topic": "SQS"
  },
  {
    "q": "A REST API built with Amazon API Gateway and AWS Lambda is experiencing high load during peak hours, causing repeated Lambda invocations for the same read-only requests. Which feature should be enabled to reduce Lambda invocations and improve response time?",
    "options": [
      "Enable API Gateway access logging",
      "Enable API Gateway response caching with an appropriate TTL",
      "Enable Lambda Provisioned Concurrency",
      "Configure a longer Lambda timeout"
    ],
    "answer": 1,
    "topic": "API Gateway"
  },
  {
    "q": "A developer is using AWS CodeDeploy to automate application deployments to Amazon EC2 instances. After the application is installed, a database migration script must run before the application starts accepting traffic. Which AppSpec lifecycle hook should be used to run the migration script?",
    "options": [
      "BeforeInstall",
      "AfterInstall",
      "ApplicationStart",
...
// Topic tagging - specific services first; two-pass: question text then options

const SERVICES = [
  {
    "name": "Lambda",
    "emoji": "λ",
    "desc": "AWS Lambda is a serverless compute service that runs code in response to events. You pay only for compute time consumed; no server management required.",
    "bullets": [
      "Max 15-minute timeout; memory 128MB–10GB",
  ...
  },
  {
    "name": "API Gateway",
    "emoji": "🔗",
    "desc": "Amazon API Gateway is a fully managed service for creating, publishing, and securing APIs at any scale. Handles traffic, auth, and monitoring.",
    "bullets": [
      "REST, HTTP, and WebSocket APIs",
      "Integrates with Lambda, EC2, HTTP backends",
      "Usage plans + API keys for throttling",
      "Stage variables for environment config",
      "Caching reducesbackend calls (per-method)"
    ]
  },
  {
    "name": "DynamoDB",
    "emoji": "🗄",
    "desc": "Amazon DynamoDB is a fully managed NoSQL database offering single-digit millisecond performance at any scale. Supports key-value and document models.",
    "bullets": [
      "Partition key required; sort key optional",
      "GSI = flexible queries; LSI = same-partition range",
      "DAX = microsecond caching layer",
      "DynamoDB Streams for change capture",
      "Conditional writes prevent overwrite conflicts"
    ]
  },
  {
    "name": "SQS",
    "emoji": "📬",
    "desc": "Amazon SQS is a fully managed message queuing service for decoupling components. Supports Standard (at-least-once) and FIFO (exactly-once) queues.",
    "bullets": [
      "Default visibility timeout: 30 seconds",
      "Max message size: 256 KB",
      "Long polling (up to 20s) reduces empty responses",
      "Dead-letter queues capture failed messages",
      "ReceiveMessage API: set MaxNumberOfMessages up to 10"
    ]
  },
  {
    "name": "SNS",
    "emoji": "📢",
    "desc": "Amazon SNS is a pub/sub messaging service for app-to-app and app-to-person communication. Topics fan out messages to multiple subscribers.",
    "bullets": [
      "Subscribers: SQS, Lambda, HTTP, Email, SMS",
      "Message filtering reduces processing overhead",
      "JSON format for notifications",
      "Fan-out pattern: SNS → multiple SQS queues",
      "Mobile push via platform endpoints"
    ]
  },
  {
    "name": "Kinesis",
    "emoji": "🌊",
    "desc": "Amazon Kinesis enables real-time processing of streaming data at scale. Kinesis Data Streams is for custom processing; Firehose for loading to destinations.",
    "bullets": [
      "Shards: 1 MB/s write, 2 MB/s read each",
      "ProvisionedThroughputExceeded → add shards or backoff",
      "Retention: 24h default, up to 365 days",
      "KCL manages shard checkpointing and balancing",
      "Firehose loads to S3, Redshift, OpenSearch"
    ]
  },
  {
    "name": "S3",
    "emoji": "🪣",
    "desc": "Amazon S3 is object storage with 11 nines (99.999999999%) durability. It stores any amount of data and provides a simple web interface.",
    "bullets": [
      "Max object size: 5 TB (multipart required >5 GB)",
      "Presigned URLs for time-limited access",
      "Max 100 buckets per account (can request more)",
      "SSE-S3, SSE-KMS, SSE-C encryption options",
      "Versioning + MFA Delete for data protection"
    ]
  },
  {
    "name": "CloudFront",
    "emoji": "⚡",
    "desc": "Amazon CloudFront is a CDN that delivers content globally with low latency. Caches content at edge locations close to users.",
    "bullets": [
      "TTL controls cache duration",
      "Invalidation removes objects before TTL expires",
      "Signed URLs/cookies for private content",
      "Origin: S3, ALB, EC2, or custom HTTP",
  ...
  },
  {
    "name": "ElastiCache",
    "emoji": "🧠",
    "desc": "Amazon ElastiCache is a managed in-memory caching service (Redis/Memcached). Reduces database load and improves response times.",
    "bullets": [
      "Redis: persistence, replication, pub/sub, Lua",
      "Memcached: multi-threaded, simpler use cases",
      "Lazy loading: only cache on cache miss",
      "Write-through: update cache on every write",
      "Invalidate stale data when source changes"
    ]
  },
  {
    "name": "RDS",
    "emoji": "🐘",
    "desc": "Amazon RDS is a managed relational database service supporting multiple engines. It automates backups, patching, and failover.",
    "bullets": [
      "Engines: MySQL, PostgreSQL, Oracle, SQL Server, Aurora",
      "Multi-AZ: synchronous standby, automatic failover",
      "Read replicas: async, improves read scaling",
      "Point-in-time recovery via automated backups",
      "Aurora: up to 5× MySQL, 3× PostgreSQL performance"
    ]
  },
  {
    "name": "CodeDeploy",
    "emoji": "🚀",
    "desc": "AWS CodeDeploy automates deployments to EC2, Lambda, ECS, and on-premises. Supports in-place and blue/green strategies.",
    "bullets": [
      "appspec.yml defines deployment lifecycle hooks",
      "In-place: updates existing instances",
      "Blue/green: new instances, traffic shifted after validation",
  ...
  },
  {
    "name": "CodePipeline",
    "emoji": "🔄",
    "desc": "AWS CodePipeline is a CI/CD service that automates build, test, and deploy. It orchestrates other AWS and third-party tools.",
    "bullets": [
      "Sources: CodeCommit, GitHub, S3",
      "Build: CodeBuild, Jenkins",
      "Deploy: CodeDeploy, Beanstalk, ECS, CloudFormation",
      "Manual approval actions pause pipeline",
      "CloudWatch Events trigger on pipeline state changes"
    ]
  },
  {
    "name": "CodeCommit",
    "emoji": "📁",
    "desc": "AWS CodeCommit is a managed Git hosting service. Secure, private repositories with no size limits.",
    "bullets": [
      "HTTPS: use IAM-generated Git credentials",
      "SSH: attach public key to IAM user",
      "Supports pull requests and code reviews",
      "Triggers to Lambda or SNS on events",
  ...
  },
  {
    "name": "CodeBuild",
    "emoji": "🔨",
    "desc": "AWS CodeBuild is a fully managed CI service that compiles source code, runs tests, and produces deployment-ready artifacts. No build servers to manage.",
    "bullets": [
      "buildspec.yml defines phases: install, pre_build, build, post_build",
      "Managed Docker environments; custom images supported",
      "Env variables + Secrets Manager / Parameter Store integration",
      "CloudWatch Logs for output; S3 for artifact caching",
      "Integrates with CodePipeline for full CI/CD workflows"
    ]
  },
  {
    "name": "CloudFormation",
    "emoji": "🏗",
    "desc": "AWS CloudFormation lets you model infrastructure as JSON or YAML templates, enabling repeatable and version-controlled deployments.",
    "bullets": [
      "Outputs + Export for cross-stack references (Fn::ImportValue)",
      "Mappings for environment-specific values (e.g. AMIs)",
      "Change sets preview impact before execution",
      "DeletionPolicy: Retain or Snapshot",
      "SAM extends CFN with serverless resource types (Transform)"
    ]
  },
  {
    "name": "ECS",
    "emoji": "🐳",
    "desc": "Amazon ECS is a managed container orchestration service. Use Fargate for serverless containers or EC2 launch type for more control.",
    "bullets": [
      "Task definition: container image, CPU, memory, ports",
      "ECS_ENABLE_TASK_IAM_ROLE for per-task IAM roles",
      "Fargate: no EC2 fleet to manage",
      "Service auto scaling with CloudWatch metrics",
      "Task placement: spread, binpack, random strategies"
    ]
  },
  {
    "name": "Cognito",
    "emoji": "👤",
    "desc": "Amazon Cognito provides user identity management. User pools for authentication; identity pools for AWS resource access.",
    "bullets": [
      "User pools: sign-up/sign-in, JWTs (ID + Access + Refresh)",
      "Identity pools: exchange tokens for temp AWS credentials",
      "Supports Facebook, Google, Apple, SAML IdPs",
      "MFA and adaptive auth available",
      "Cognito Sync for cross-device user data"
    ]
  },
  {
    "name": "IAM",
    "emoji": "🔐",
    "desc": "AWS IAM controls access to AWS services. Manage users, groups, roles, and policies to implement least-privilege access.",
    "bullets": [
      "Explicit deny always overrides any allow",
      "All requests denied by default",
      "Use roles (not access keys) for EC2 and Lambda",
      "iam:PassRole required to assign roles to services",
      "Managed vs. inline policies: prefer managed"
    ]
  },
  {
    "name": "KMS",
    "emoji": "🔑",
    "desc": "AWS KMS manages cryptographic keys. It integrates with most AWS services for encryption at rest and in transit.",
    "bullets": [
      "CMK used for envelope encryption (wraps data keys)",
      "GenerateDataKey returns plaintext + encrypted data key",
      "Encrypt API limit: 4 KB; use data keys for larger data",
      "associate-kms-key to encrypt CloudWatch Logs",
      "Annual automatic key rotation available"
    ]
  },
  {
    "name": "Secrets Manager",
    "emoji": "🤫",
    "desc": "AWS Secrets Manager stores, rotates, and retrieves secrets like database credentials, API keys, and OAuth tokens.",
    "bullets": [
      "Automatic rotation for RDS, Redshift, DocumentDB",
      "Lambda function performs actual rotation logic",
      "Retrieve via SDK — no hardcoding credentials",
  ...
  },
  {
    "name": "X-Ray",
    "emoji": "🔍",
    "desc": "AWS X-Ray provides distributed tracing for applications. It helps identify performance bottlenecks and errors across microservices.",
    "bullets": [
      "Trace = collection of segments from one request",
      "Annotations indexed for filtering; metadata is not",
      "Sampling reduces data volume and cost",
      "X-Ray daemon on EC2; auto-enabled on Lambda",
      "Use X-Ray SDK to instrument application code"
    ]
  },
  {
    "name": "CloudWatch",
    "emoji": "📊",
    "desc": "Amazon CloudWatch monitors AWS resources and applications. Collects metrics, logs, and events for observability.",
    "bullets": [
      "Custom metrics via put-metric-data (SDK or CLI)",
      "High-resolution metrics: 1-second granularity",
      "Metric filters extract values from log groups",
      "Alarms trigger SNS, Auto Scaling, EC2 actions",
  ...
  },
  {
    ...
    "emoji": "🌱",
    "desc": "AWS Elastic Beanstalk deploys and scales web applications. Upload code and Beanstalk handles provisioning, load balancing, and monitoring.",
    "bullets": [
      "Deployments: All at once, Rolling, Immutable, Blue/Green",
      "Immutable: safest with quick rollback",
      "ebextensions (.config files) for customization",
      ".platform directory for server configuration hooks",
      "Supports Docker, Java, .NET, Node.js, PHP, Python, Ruby"
    ]
  },
  {
    "name": "Step Functions",
    "emoji": "📋",
    "desc": "AWS Step Functions coordinates AWS services into serverless workflows using state machines. Visual workflow editor included.",
    "bullets": [
      "States: Task, Choice, Wait, Parallel, Map, Pass, Fail",
      "ResultPath in Catch: preserve original input with error",
      "Max execution duration: 1 year (standard workflow)",
      "Express workflows for high-volume short tasks",
      "Visual console debugger for workflow executions"
    ]
  },
  {
    "name": "EventBridge",
    "emoji": "🌉",
    "desc": "Amazon EventBridge is a serverless event bus connecting AWS services, SaaS apps, and custom apps using events.",
    "bullets": [
      "Rules route events matching patterns to targets",
      "Targets: Lambda, SQS, SNS, Step Functions, etc.",
      "Schema registry for event discovery and binding",
      "Custom and partner event buses available",
      "Replaces/extends CloudWatch Events (same API)"
    ]
  }
];
